...
class Test_Vault__Key_Manager:
    ...
    def test_generate_key_id(self):
        ...
        assert len(kid) == 16  # 16 hex chars (raw, no prefix)
    ...
    def test_store_and_load_public_key(self):
        private, public = self.km.generate_branch_key_pair()
        kid = 'key-rnd-imm-' + self.km.generate_key_id()
    ...
    def test_list_keys(self):
        private, public = self.km.generate_branch_key_pair()
        kid1 = 'key-rnd-imm-' + self.km.generate_key_id()
        kid2 = 'key-rnd-imm-' + self.km.generate_key_id()
