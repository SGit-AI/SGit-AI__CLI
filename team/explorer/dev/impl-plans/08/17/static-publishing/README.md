...
| **[`13__derived-publish-vaults.md`](13__derived-publish-vaults.md)** | **Derived publish vaults** (`sgit vault derive`) — publish a rekeyed copy without exposing the source vault's keys; snapshot vs history mode, incremental refresh, the id-map | the maintainer (decisions 18–21), then whoever builds PD1–PD4 |
