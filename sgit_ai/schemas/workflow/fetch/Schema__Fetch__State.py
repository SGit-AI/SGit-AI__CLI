"""Accumulating state schema shared by all fetch workflow steps."""
...
class Schema__Fetch__State(Type_Safe):
    """Accumulating state passed through all fetch workflow steps (fetch = pull without merge)."""
